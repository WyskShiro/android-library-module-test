...
interface Strings {
    val goToConfigurations: String
    val imageAccessRationale: String
    ...
    val globalFacebook: String
    val globalGoogle: String
    val globalOr: String
    val globalWait: String
    val globalTryAgain: String
    val globalCancel: String
    val globalDoLogin: String
    val globalOk: String
    val globalYes: String
    val globalNo: String
    val activityRecoverPasswordTitle: String
    val activityRecoverPasswordConfirmation: String
}