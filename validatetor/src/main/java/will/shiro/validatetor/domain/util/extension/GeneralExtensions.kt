package will.shiro.validatetor.domain.util.extension

import will.shiro.validatetor.domain.util.DateMasks
...
fun String.resolveTimeZone(
    pattern: String = will.shiro.validatetor.domain.util.DateMasks.DATE_MASK_BR
): Calendar {
...
fun String.toDate(pattern: String = will.shiro.validatetor.domain.util.DateMasks.DATE_MASK_BR): Date {
...
fun Date.format(pattern: String = will.shiro.validatetor.domain.util.DateMasks.DATE_MASK_BR): String {
